...
var format_CoveringfilmsTonsyr_10 = new ol.format.GeoJSON();
var features_CoveringfilmsTonsyr_10 = format_CoveringfilmsTonsyr_10.readFeatures(json_CoveringfilmsTonsyr_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CoveringfilmsTonsyr_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CoveringfilmsTonsyr_10.addFeatures(features_CoveringfilmsTonsyr_10);
var lyr_CoveringfilmsTonsyr_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CoveringfilmsTonsyr_10, 
                style: style_CoveringfilmsTonsyr_10,
                popuplayertitle: "Covering films (Tons/yr)",
                interactive: true,
    title: 'Covering films (Tons/yr)<br />\
    <img src="styles/legend/CoveringfilmsTonsyr_10_0.png" /> 0 - 1.3<br />\
    <img src="styles/legend/CoveringfilmsTonsyr_10_1.png" /> 1.3 - 200<br />\
    <img src="styles/legend/CoveringfilmsTonsyr_10_2.png" /> 200 - 1000<br />\
    <img src="styles/legend/CoveringfilmsTonsyr_10_3.png" /> 1000 - 2000<br />\
    <img src="styles/legend/CoveringfilmsTonsyr_10_4.png" /> 2000 - 25000<br />\
    <img src="styles/legend/CoveringfilmsTonsyr_10_5.png" /> 25000 - 42000<br />'
        });
...
var lyr_TotalAPWTonsyr_11 = new ol.layer.Vector({
    ...
    <img src="styles/legend/TotalAPWTonsyr_11_0.png" /> 50 - 5000<br />\
    <img src="styles/legend/TotalAPWTonsyr_11_1.png" /> 5000 - 40000<br />\
    <img src="styles/legend/TotalAPWTonsyr_11_2.png" /> 40000 - 80000<br />\
    <img src="styles/legend/TotalAPWTonsyr_11_3.png" /> 80000 - 150000<br />\
    <img src="styles/legend/TotalAPWTonsyr_11_4.png" /> 150000 - 230000<br />\
    <img src="styles/legend/TotalAPWTonsyr_11_5.png" /> 230000 - 330000<br />'
        });

lyr_ESRIGraylight_0.setVisible(true);lyr_UAAha_1.setVisible(false);lyr_SupportTonsyr_2.setVisible(false);lyr_BagsTonsyr_3.setVisible(false);lyr_ContainersTonsyr_4.setVisible(false);lyr_IrrigationTonsyr_5.setVisible(false);lyr_NetsTonsyr_6.setVisible(false);lyr_MulchingfilmsTonsyr_7.setVisible(false);lyr_HighTunnelsTonsyr_8.setVisible(false);lyr_LowtunnelsTonsyr_9.setVisible(false);lyr_CoveringfilmsTonsyr_10.setVisible(false);lyr_TotalAPWTonsyr_11.setVisible(true);
var layersList = [lyr_ESRIGraylight_0,lyr_UAAha_1,lyr_SupportTonsyr_2,lyr_BagsTonsyr_3,lyr_ContainersTonsyr_4,lyr_IrrigationTonsyr_5,lyr_NetsTonsyr_6,lyr_MulchingfilmsTonsyr_7,lyr_HighTunnelsTonsyr_8,lyr_LowtunnelsTonsyr_9,lyr_CoveringfilmsTonsyr_10,lyr_TotalAPWTonsyr_11];
...
lyr_CoveringfilmsTonsyr_10.set('fieldAliases', {'CNTR_CODE': 'CNTR_CODE', 'Region': 'Region', 'Cov_Films': 'Cov_Films', });
lyr_TotalAPWTonsyr_11.set('fieldAliases', {'CNTR_CODE': 'CNTR_CODE', 'Region': 'Region', 'Total_APW': 'Total_APW', });
...
lyr_CoveringfilmsTonsyr_10.set('fieldImages', {'CNTR_CODE': 'TextEdit', 'Region': 'TextEdit', 'Cov_Films': 'TextEdit', });
lyr_TotalAPWTonsyr_11.set('fieldImages', {'CNTR_CODE': 'TextEdit', 'Region': 'TextEdit', 'Total_APW': 'TextEdit', });
...
lyr_CoveringfilmsTonsyr_10.set('fieldLabels', {'CNTR_CODE': 'hidden field', 'Region': 'inline label - visible with data', 'Cov_Films': 'inline label - visible with data', });
lyr_TotalAPWTonsyr_11.set('fieldLabels', {'CNTR_CODE': 'hidden field', 'Region': 'inline label - visible with data', 'Total_APW': 'inline label - visible with data', });
lyr_TotalAPWTonsyr_11.on('precompose', function(evt) {
